...
\vspace{1.0cm}
\item[] {\songti\zihao{4}\bf{攻读博士学位期间已完成的论文：}}
\setcounter{enumiv}{0}
...
%\item[] {\songti\zihao{4}\bf{攻读博士学位期间已发表的论文：}}
%\item Dong Wang, David S. Smith and Xiaoping Yang. Dynamic MR Image Reconstruction using TGV and Low-rank Decomposition. 2019. Accepted. doi: 10.1002/mrm.28064.
