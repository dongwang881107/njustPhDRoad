...
因此，结合流程图\ref{fig:snapmrf}和如上核函数的功能，snapMRF字典生成与匹配的详细流程如算法\ref{alg:snapMRF}所示。
\begin{algorithm}
